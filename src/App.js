    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ position:'relative', zIndex:1 }}>
          <p style={{ fontSize:'16px', letterSpacing:'0.25em', fontWeight:900, textTransform:'uppercase', marginBottom:'12px', background:GRADIENT, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text', margin:'0 0 12px' }}>
            YUWOL
          </p>
          <h1 style={{ fontSize:'52px', fontWeight:900, lineHeight:'0.95', marginBottom:'16px', color:TEXT, letterSpacing:'-0.04em', margin:'0 0 16px' }}>
            Practice<br/>
            <span style={{ background:GRADIENT, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>
              or Die.
            </span>
          </h1>
          <p style={{ fontSize:'15px', fontWeight:700, marginBottom:'32px', color:TEXT_MUTED, margin:'0 0 32px' }}>
            당신은 매일 연습하고 있는가.
          </p>
          ...
          <p style={{ textAlign:'center', fontSize:'11px', marginTop:'16px', color:'#555', margin:'16px 0 0' }}>
